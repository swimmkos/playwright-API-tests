...
test('create article', async({page, request}) =>{
    ...
    await page.getByRole('textbox', {name: 'What\'s this article about?'}).fill('About the Playwthight')
    ...
    const articleResponseBudy = await articleResponse.json()
    const slugId = articleResponseBudy.article.slug
